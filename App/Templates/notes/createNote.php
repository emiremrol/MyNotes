...
<div class="container border-bottom">
    <header class="d-flex justify-content-between">
        ...
        <div class="me-4 d-flex align-items-center">
            ...
            <a class="btn btn-primary rounded-pill" href="profile.php">Back to profile</a>
...
<section class="container p-3 d-flex justify-content-center">
    <form action="" class="form" method="post">
        <div class="row mb-2">
            <div class="col">
                <input type="text" name="title" class="form-control" placeholder="Enter note name" required>
            </div>
            <div class="col">
